...
async handleSubmit(event){
    ...
    const { id, Patient_name, _address, phone, email, hash} = this.state
   ...
   return (
     <div>
      ...
      <div>
        ...
        <div>
        <label htmlFor='id'>Enter your id</label>
        <input type='text'  name = 'id' id = 'id1' onChange = {this.handleChange}/>
        </div>
      ...
      <hr />
        ...
        <p>Patient Name is : {this.state.Patient_name}</p>
        <p>Patient Adrress : {this.state._address}</p>
        <p>Contact no is : {this.state.phone}</p>
        <p>Email address is : {this.state.email}</p>
